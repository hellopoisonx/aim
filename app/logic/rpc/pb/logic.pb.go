...
const file_logic_proto_rawDesc = "" +
	...
	"\x05users\x18\x01 \x03(\v2\x17.logic.UserInfoResponseR\x05users\"\x96\x01\n" +
	...
	"\x04name\x18\x04 \x01(\tR\x04name\"\xf9\x01\n" +
...
var file_logic_proto_msgTypes = make([]protoimpl.MessageInfo, 49)
