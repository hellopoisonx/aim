...
type PushMessageReq struct {
	...
	SourceDeviceId   string                 `protobuf:"bytes,13,opt,name=source_device_id,json=sourceDeviceId,proto3" json:"source_device_id,omitempty"`    // 原始发送设备 ID；仅用于跳过发送端设备，不透传给客户端
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *PushMessageReq) GetSourceDeviceId() string {
	if x != nil {
...
const file_shared_proto_gateway_gateway_proto_rawDesc = "" +
	...
	"\fdisplay_name\x18\x03 \x01(\tR\vdisplayName\"\xdb\x03\n" +
	...
	"senderInfo\x12(\n" +
	"\x10source_device_id\x18\r \x01(\tR\x0esourceDeviceId\"+\n" +
